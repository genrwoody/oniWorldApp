...
export const configuration: Configuration = {
    ...
    mixing: [
        { type: 0, key: "dlc2", name: "The Bionic Booster Pack" },
        { type: 1, key: "mix4", name: "Ceres Fragment" },
        { type: 1, key: "mix3", name: "Nectar" },
        { type: 1, key: "mix2", name: "Cool Pool" },
        { type: 1, key: "mix1", name: "Ice Cave" },
        { type: 0, key: "dlc3", name: "The Frosty Planet Pack" },
    ],
    geyser: [
